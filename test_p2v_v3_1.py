...
ITER_SIZE = 1
NUM_WORKERS = 0
VAL_IMAGE_DIRECTORY_TARGET = "./dataset/mpia/train_image_512"
VAL_LABEL_DIRECTORY_TARGET = "./dataset/mpia/train_label_512"
...
def main():
    ...
    memory = torch.load(save_path_m, weights_only=True, map_location=torch.device("cuda"))
    ...
    model.load_state_dict(torch.load(save_path, weights_only=True, map_location=torch.device("cuda")))
    print('load success')
